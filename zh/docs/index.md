...
<div class="rom-hero">
    ...
    <p class="rom-hero-subtitle">模拟灵魂。超越时代的造物。</p>
</div>

<div class="rom-mission">
    <p class="rom-mission-text">
        <strong>Audrey — 回归本源。</strong>
    </p>
    <p class="rom-mission-text" style="margin-top: 1rem;">
        我们创造将真空管与现代控制系统相结合的设备。
        按照 Decima8 原则指挥模拟 — 带有模拟温暖和确定性响应。
        这不是关于 IT 或 AI。这是关于超越时间的物理乐趣。
    </p>
</div>
...
<div class="rom-domains">
    <div class="rom-domain-item">
        ...
        <h3 class="rom-domain-title"> Малыш (小家伙)</h3>
        <p class="rom-domain-desc">电子管推挽式 A/AB 类放大器，带数字控制器固定偏置，内置特性曲线仪和灯管测试仪。</p>
        <a href="malysh/" class="rom-domain-link">→ Малыш 规格</a>
    </div>

    <div class="rom-domain-item">
        <div class="rom-domain-icon">🧠</div>
        <h3 class="rom-domain-title">电子管 Decima</h3>
        <p class="rom-domain-desc">16 管模拟神经形态核心，用于射击游戏自动瞄准。</p>
        <a href="decima/" class="rom-domain-link">→ Decima 规格</a>
    </div>
</div>
...
<div class="rom-mission" style="margin-top: 2rem;">
    <p class="rom-mission-text">
        Audrey 是 Rule-ROM 联邦面向非技术受众的前沿。
        我们相信模拟技术并未消亡 — 它们只是等待重新构想。
    </p>
    <p class="rom-mission-text" style="margin-top: 1rem;">
        电子管提供基础能量和自然起音，这是软件无法模拟的，
        而我们的数字"指挥"确保这种功率在任何工作模式下都保持完美的线性和稳定。
    </p>
</div>
...
<div class="rom-contact" style="margin-top: 2rem;">
    <h3 class="rom-contact-title">联系项目</h3>
